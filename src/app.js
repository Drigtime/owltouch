...
import { itemsBank } from './plugins/htmlElementInstance';
import loadScript from './plugins/loadPath';
import { bankLayerGroup, dofusCoordsToGeoCoords, drawDofusMapBoundsOnMouseMove, geoCoordsToDofusCoords, highlightSubArea, map, phoenixLayerGroup } from './plugins/map';
import { checkIfMapAlreadyExist, deleteAction, generateScript, getIdOfAutoComplete, icon, movementType, onMapClick, resizeMarker } from './plugins/pathMaker';
