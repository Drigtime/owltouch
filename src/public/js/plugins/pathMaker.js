...
const items = JSON.parse(fs.readFileSync(path.join(__dirname, "../../../data/json/d2o/Items.json")));
const monsters = JSON.parse(fs.readFileSync(path.join(__dirname, "../../../data/json/d2o/Monsters.json")));
const interactive = JSON.parse(fs.readFileSync(path.join(__dirname, "../../../data/json/d2o/Interactive.json")));
