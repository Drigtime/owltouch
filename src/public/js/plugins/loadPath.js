  ...
  Object.values(paths).forEach((mapInfo) => {
    ...
    if (Object.prototype.hasOwnProperty.call(mapInfo, 'npcBank')) {
      ...
      directions.forEach((direction) => {
        const coord = typeof mapInfo.map === 'string' ? [parseInt(mapInfo.map.split(',')[0], 10), parseInt(mapInfo.map.split(',')[1], 10)] : [mapList[mapInfo.map].posX, mapList[mapInfo.map].posY];
